...
function renderProcurementCard(container, text) {
    ...
    container.innerHTML = `
        ...
        <div class="action-buttons-row">
            ...
            <button class="btn-action" onclick="handleProcAction('approval')">
...
function handleProcAction(action) {
    ...
    if (action === 'rfq') {
        ...
        if (input) {
            input.value = "Generate an Executive Approval Summary for these products and suppliers based on our current discussion.";
...
function exportToPDF(actionType = 'print') {
    ...
    const printContent = `
        ...
        <body>
            ...
            <div class="footer">Generated by Procurement Procurement Intelligence Platform · ${today}</div>
        </body>
        </html>`;
